  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        myCamBg:  "url('/images/CustImages/CamBg.png')",
        mySignPadbg: "url('/images/CustImages/Signaturepadbg.png')",
        myButton: "url('/images/CustImages/Button.png')",
        headerBdr: "url('/images/CustImages/headerBorder.png')",
        footerBdr: "url('/images/CustImages/footerBorder.png')",
        bandgBg: "url('/images/CustImages/bandgBg.png')",
      },
      content: {
